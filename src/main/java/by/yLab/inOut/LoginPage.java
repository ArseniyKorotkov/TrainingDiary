...
public class LoginPage extends Page {
    ...
    public static UserDto Registration() {
        ...
        requestDataFormatter(FIRST_NAME);
        String firstName = SCANNER.nextLine();
        requestDataFormatter(LAST_NAME);
        String lastName = SCANNER.nextLine();
        requestDataFormatter(BIRTHDAY);
        String birthday = SCANNER.nextLine();
        requestDataFormatter(EMAIL);
    ...
    public static UserDto Authorization() {
        ...
        requestDataFormatter(EMAIL);
        String email = SCANNER.nextLine();
        requestDataFormatter(LAST_NAME_LIKE_PASSWORD);
        String lastName = SCANNER.nextLine();
        System.out.println();
    ...
    /**
     * Форматирует строку запроса пользователю
     *
     * @param data запрашиваемый у пользователя параметр
     */
    private static void requestDataFormatter(String data) {
